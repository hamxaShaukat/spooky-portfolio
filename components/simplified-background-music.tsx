...
export default function SimplifiedBackgroundMusic() {
  ...
  return (
    <>
      ...
      {/* Initial Play Prompt with Close Button */}
      <AnimatePresence>
        {showPrompt && (
          <motion.div
          ...
          >
            <motion.div
              className="bg-black/90 border border-purple-500/50 rounded-lg p-6 backdrop-blur-sm relative"
              animate={{
                boxShadow: [
